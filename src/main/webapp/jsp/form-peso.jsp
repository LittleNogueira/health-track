            ...
            <div class="container-content" >
                ...
                <div class="main-content" >
                    ...
                    <div class="row" >
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Formulário de peso</h5>
                                <form action="dashboard.jsp">
                                    <div class="mb-3">
                                        <label for="data-peso" class="form-label">Data pesagem</label>
                                        <input type="date" class="form-control" id="data-peso" placeholder="04/02/2021" required />
                                    </div>
                                    <div class="mb-3">
